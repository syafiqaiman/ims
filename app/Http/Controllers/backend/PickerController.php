...
class PickerController extends Controller
{
    ...
    public function PickerTaskList()
    {
        ...
        foreach ($pickers as $picker) {
            ...
            // $picker->location_codes = $floor_location->location_codes; // Get the location_code from the floor_location
            if ($floor_location) {
                $picker->location_codes = $floor_location->location_codes; // Get the location_codes from the floor_location if it's not null
            } else {
                $picker->location_codes = null; // Set location_codes to null if $floor_location is null
            }
    ...
    public function confirmCollection(Request $request, $id, $quantity)
    {
        ...
        $order->floor_id = $picker->floor_id;
