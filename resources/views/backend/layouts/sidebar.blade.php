                        ...
                        <a href="{{ URL::to('/picker_task') }}" class="nav-link">
                            ...
                            <p>
                                ...
                                <span class="right badge badge-danger"
                                    id="picker-tasks-count">{{ $sidebarController->getCountPickerTasks() }}</span>
                            </p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ URL::to('/return-order-task') }}" class="nav-link">
                            ...
                            <p>
                                Return Order Task
                                <span class="right badge badge-danger"
                                    id="picker-return-count">{{ $sidebarController->getCountPickerReturn() }}</span>
                            </p>
                        </a>
                    </li>
                ...
                @if (Auth::user()->role == 3)
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                              <a href="{{ URL::to('/monthly-report') }}" class="nav-link">
                                  <i class="nav-icon fas  fa-archive"></i>
                                  <p>
