                                        ...
                                        <tr>
                                            ...
                                            <td class="status-cell">
                                                @if($picker->status == 'Dispose')
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm btn-dispose" data-toggle="modal" data-target="#disposeModal{{ $picker->id }}">Dispose this item</button>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="disposeModalLabel{{ $picker->id }}">Dispose Product</h5>
                                                                ...
                                                                <form action="{{ route('disposeProductPicker', ['pickerId' => $picker->id]) }}" method="POST">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Are you sure you want to dispose of this product?</p>
                                                                    </div>
                                                ...
                                                @elseif($picker->status == 'Refurbish')
                                                    <!-- Button trigger modal -->
                                                    <button type="button" class="btn btn-dark btn-sm btn-rerack" data-toggle="modal" data-target="#rerackModal{{ $picker->id }}">Refurbish this item</button>
                                                    ...
                                                    <div class="modal fade" id="rerackModal{{ $picker->id }}" tabindex="-1" role="dialog" aria-labelledby="rerackModalLabel{{ $picker->id }}" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="{{ route('refurbishedProduct', ['pickerId' => $picker->id]) }}" method="POST">
                                                                    @csrf
                                                                    <div class="modal-body">
                                                                        <p>Are you sure you want to rerack this product?</p>
                                                                        <div class="form-group">
                                                                            <label for="rackLocation{{ $picker->id }}">Rack Location:</label>
                                                                            <input type="text" class="form-control" id="rackLocation{{ $picker->id }}" name="rack_location" value="{{ $picker->product->rack->location_code }}" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
