        ...
        <table id="example1" class="table">
            ...
            <tbody>
                ...
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>
                        <a href="{{ URL::to('/retrieve_product/'.$allRequestProducts->id) }}" class="btn btn-sm btn-success">Retrieve Product</a>
                        <a href="{{ URL::to('/return_product/'.$allRequestProducts->id) }}" class="btn btn-sm btn-danger">Return Product</a>
                    </td>
                </tr>
