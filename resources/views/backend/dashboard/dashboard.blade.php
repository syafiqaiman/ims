...
<title>Dashboard</title>
    ...
    <canvas id="salesChart" height="225" style="height: 180px; display: block; width: 518px;" width="647" class="chartjs-render-monitor"></canvas>
    </div>
    ...
    <canvas id="pieChart" height="90" style="display: block; height: 72px; width: 145px;" width="181" class="chartjs-render-monitor"></canvas>
    </div>
