...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=101751400ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="0">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myinventory&table=rack_locations">`myinventory`.`rack_locations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myinventory&table=pickers">`myinventory`.`pickers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myinventory&table=users">`myinventory`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myinventory&table=weights">`myinventory`.`weights`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myinventory&table=products">`myinventory`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myinventory&table=orders">`myinventory`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myinventory&table=quantities">`myinventory`.`quantities`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myinventory&table=bookcategories">`myinventory`.`bookcategories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myinventory&table=companies">`myinventory`.`companies`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=myinventory&table=carts">`myinventory`.`carts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6056286f326c45692b2e2e5c6b3b515b">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="0"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="myinventory" targettable="rack_locations">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `rack_locations`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="myinventory" targettable="rack_locations">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `rack_locations`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="myinventory" targettable="weights">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `weights`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="myinventory" targettable="rack_locations">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `rack_locations`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="myinventory" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `weights`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="myinventory" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `rack_locations`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="myinventory" targettable="pickers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `pickers`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="myinventory" targettable="rack_locations">
                            <div class="action_content">
